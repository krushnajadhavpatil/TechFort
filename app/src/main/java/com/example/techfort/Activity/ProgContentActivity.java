...
import com.example.techfort.databinding.ActivityProgContentBinding;
...
public class ProgContentActivity extends AppCompatActivity {

    String url;
    String topicId;
    String topicName;
    String topicUrl;
    ActivityProgContentBinding binding;
    FirebaseFirestore database;
    FirebaseAuth firebaseAuth;
    String current_user_id;
    private PDFView pdfView;
    public final String TAG = ProgContentActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog_content);
        binding = ActivityProgContentBinding.inflate(getLayoutInflater());
        ...
        binding.bookmark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, " CatId  " + ProgrammingAdapter.getProgId());
                Log.d(TAG, " TopicId  " + ProgTopicAdapter.getProgTopicId());
                ...
                database.collection("Bookmark").add(map).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(ProgContentActivity.this, "Bookmark Added", Toast.LENGTH_SHORT).show();
                        } else {
                            String e = task.getException().getMessage();
                            Toast.makeText(ProgContentActivity.this, "Error" + e, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
...
//                            binding.bookmark.setBackgroundResource(R.drawable.turned);
        ...
        binding.compiler.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        binding.quiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), ProgQuizActivity.class));
            }
        });
